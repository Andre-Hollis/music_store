...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if(empty($categoryErr) && empty($brandErr) && empty($yearErr) && empty($priceErr) && empty($overduePriceErr) && empty($userIDErr)){
        ...
        $sql = "UPDATE items 
        SET category = ?, brand = ?, yearMade = ?, features = ?, 
        pricePerDay = ?, overduePrice = ?, available = ?, userID = ? 
...
<body>
    <div class="wrapper">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="mt-4 mb-3">Update Item</h2>
                    <form action="./item-update.php?itemID=<?php echo $_GET['itemID']; ?>" method="post">
                        <div class="alert alert-warning">
                            ...
                            <p>Are you sure you want to update this item: ID<b><?php echo $_GET['itemID']; ?></b>?</p>
                            <p>
