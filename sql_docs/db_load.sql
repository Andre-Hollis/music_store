...
INSERT INTO items (category, brand, yearMade, features, pricePerDay, 
overduePrice, available, userID) 
VALUES ("Drum", "Yamaha", "2020", "Red, Good condition.", 10, 20, FALSE, 1), 
("Drum", "Sonor", "2018", "Blue, Okay condition.", 8, 15, TRUE, NULL), 
("Drum", "Tama", "2010", "Red, Bad condition.", 5, 13, FALSE, 2), 
("Drum", "Ludwig", "2021", "Black, Great condition!", 15, 30, TRUE, NULL), 
("Guitar", "Martin", "2015", "Red, Good condition.", 11, 22, FALSE, 1), 
("Guitar", "Yamaha", "2020", "Yellow, Good condition.", 8, 20, FALSE, 4), 
("Guitar", "Taylor", "2015", "Red, Bad condition.", 5, 10, TRUE, NULL), 
("Guitar", "Yamaha", "2010", "Red, Okay condition.", 10, 20, TRUE, NULL), 
("Guitar", "Martin", "2016", "Blue, Bad condition.", 5, 10, FALSE, 6), 
("Guitar", "Taylor", "2020", "Red, Good condition.", 11, 22, TRUE, NULL), 
("Guitar", "Yamaha", "2021", "Purple, Great condition.", 15, 30, TRUE, NULL), 
("Keyboard", "Yamaha", "2020", "Good condition.", 10, 20, TRUE, NULL), 
("Keyboard", "Roland", "2010", "Okay condition.", 10, 20, FALSE, 7), 
...
("Amplifier", "Marshall", "2020", "Good condition.", 10, 20, FALSE, 1), 
("Amplifier", "Peavey", "2021", "Great condition.", 10, 20, FALSE, 6), 
